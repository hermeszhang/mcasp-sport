...
static inline void mcasp_set_bits(struct mcasp_dev *mcasp, u32 offset,
				  u32 val)
{
...
static inline void mcasp_clr_bits(struct mcasp_dev *mcasp, u32 offset,
				  u32 val)
{
	void __iomem *reg = mcasp->base + offset;
	__raw_writel((__raw_readl(reg) & ~(val)), reg);
...
static inline void mcasp_mod_bits(struct mcasp_dev *mcasp, u32 offset,
				  u32 val, u32 mask)
{
	void __iomem *reg = mcasp->base + offset;
...
static inline void mcasp_set_reg(struct mcasp_dev *mcasp, u32 offset,
				 u32 val)
{
	__raw_writel(val, mcasp->base + offset);
}

static inline u32 mcasp_get_reg(struct mcasp_dev *mcasp, u32 offset)
{
	return (u32)__raw_readl(mcasp->base + offset);
}

static inline void mcasp_set_ctl_reg(struct mcasp_dev *mcasp, u32 ctl_reg,
                                     u32 val)
{
	int i = 0;
...
static inline bool mcasp_is_synchronous(struct mcasp_dev *mcasp)
{
